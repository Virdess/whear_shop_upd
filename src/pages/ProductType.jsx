    ...
    <IonPage>
      <IonHeader>
        ...
        <IonButtons slot="start">
          ...
          <IonTitle>{capitalize(productInfo[category].productTypes[type].catName)}</IonTitle>
        </IonToolbar>
      </IonHeader>
        ...
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large" className="page-title">
              ...
              <IonLabel>{productInfo[category].catName}</IonLabel>
            </IonTitle>
          </IonToolbar>
        </IonHeader>
